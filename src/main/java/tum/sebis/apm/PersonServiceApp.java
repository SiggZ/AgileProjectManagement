package tum.sebis.apm;

import tum.sebis.apm.config.ApplicationProperties;
import tum.sebis.apm.config.DefaultProfileUtil;
...
public class PersonServiceApp {
    ...
    public PersonServiceApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes PersonService.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PersonServiceApp.class);
